...
module nios_system_mm_interconnect_0 (
	...
	wire  [107:0] aes_decryption_core_0_aes_slave_agent_rf_source_data;                               // AES_Decryption_Core_0_AES_Slave_agent:rf_source_data -> AES_Decryption_Core_0_AES_Slave_agent_rsp_fifo:in_data
	...
	wire  [107:0] aes_decryption_core_0_aes_slave_agent_rsp_fifo_out_data;                            // AES_Decryption_Core_0_AES_Slave_agent_rsp_fifo:out_data -> AES_Decryption_Core_0_AES_Slave_agent:rf_sink_data
	...
	wire  [106:0] cmd_mux_src_data;                                                                   // cmd_mux:src_data -> AES_Decryption_Core_0_AES_Slave_agent:cp_data
	wire          cmd_mux_src_ready;                                                                  // AES_Decryption_Core_0_AES_Slave_agent:cp_ready -> cmd_mux:src_ready
	wire    [8:0] cmd_mux_src_channel;                                                                // cmd_mux:src_channel -> AES_Decryption_Core_0_AES_Slave_agent:cp_channel
	...
	wire    [8:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> sdram_pll_pll_slave_agent:cp_channel
	...
	wire    [8:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> sdram_s1_agent:cp_channel
	...
	wire  [106:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> keys_s1_agent:cp_data
	wire          cmd_mux_007_src_ready;                                                              // keys_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire    [8:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> keys_s1_agent:cp_channel
	...
	wire  [106:0] aes_decryption_core_0_aes_slave_agent_rp_data;                                      // AES_Decryption_Core_0_AES_Slave_agent:rp_data -> router_002:sink_data
	...
	wire  [106:0] keys_s1_agent_rp_data;                                                              // keys_s1_agent:rp_data -> router_009:sink_data
	...
	wire    [8:0] cmd_demux_001_src4_channel;                                                         // cmd_demux_001:src4_channel -> cmd_mux_005:sink1_channel
	...
	wire    [8:0] rsp_demux_005_src1_channel;                                                         // rsp_demux_005:src1_channel -> rsp_mux_001:sink4_channel
	...
	wire    [8:0] crosser_001_out_channel;                                                            // crosser_001:out_channel -> cmd_mux_006:sink1_channel
	...
	wire    [8:0] rsp_demux_006_src0_channel;                                                         // rsp_demux_006:src0_channel -> crosser_002:in_channel
	...
	wire    [8:0] crosser_002_out_channel;                                                            // crosser_002:out_channel -> rsp_mux:sink6_channel
	...
	wire    [8:0] rsp_demux_006_src1_channel;                                                         // rsp_demux_006:src1_channel -> crosser_003:in_channel
	...
	nios_system_mm_interconnect_0_rsp_demux_001 rsp_demux_008 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
